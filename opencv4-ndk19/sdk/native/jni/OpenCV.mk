...
OPENCV_MODULES:=stitching aruco bgsegm bioinspired ccalib dnn_objdetect dpm face freetype fuzzy hfs img_hash line_descriptor quality reg rgbd saliency stereo structured_light phase_unwrapping superres optflow surface_matching tracking datasets text dnn plot videostab video xfeatures2d shape ml ximgproc xobjdetect objdetect calib3d features2d highgui videoio imgcodecs flann xphoto photo imgproc core
